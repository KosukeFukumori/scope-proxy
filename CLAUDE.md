...
- Never include a Claude Code session URL (e.g. `https://claude.ai/code/session_...`) in a PR title or body. It is internal session state, not something a public GitHub reader needs, and should not be published.
